...
import com.example.mmm.Service.neverEndingService.SensorService;
...
/*
    ...
    private boolean isMyServiceRunning(Class<?> serviceClass) {
        ...
        for (ActivityManager.RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
            if (serviceClass.getName().equals(service.service.getClassName())) {
                Log.i(mainActivity.class.getSimpleName() + "Check", "isMyServiceRunning? true");
                return true;
            }
        }
        Log.i(mainActivity.class.getSimpleName() + "Check ", "isMyServiceRunning? false ");
        return false;
    }
    ...
    protected void onDestroy() {
        ...
        Log.i(mainActivity.class.getSimpleName() + "Check" + " : MAINACT", "onDestroy!");
        super.onDestroy();
